...
public class TimerRegistry {
    ...
    public static int createInstance(Identifier timerId, Long ownerEntityId, TimerModels.TimerPayload payload, boolean autoStart, Object world) { return TimerManager.createInstance(timerId, ownerEntityId, payload, autoStart, world); }
}
