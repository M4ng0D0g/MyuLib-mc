...
final class AnimatorComponentTest {
    public static void main(String[] args) {
        playPauseResumeAndStopDriveTargetValues();
        pingPongModeAlternatesDirectionAcrossCycles();
    }

    static void playPauseResumeAndStopDriveTargetValues() {
        ...
        animator.tick(250L);
        TestSupport.assertEquals(2.5, value.get(), 1.0e-9);
        ...
        animator.resume();
        animator.tick(750L);
        TestSupport.assertEquals(10.0, value.get(), 1.0e-9);
    ...
    static void pingPongModeAlternatesDirectionAcrossCycles() {
        ...
        animator.tick(1000L);
        TestSupport.assertEquals(7.5, value.get(), 1.0e-9);
