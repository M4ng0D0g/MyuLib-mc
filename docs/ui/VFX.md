...
Overview
This area contains compatibility helpers, a small effect DSL, and prebuilt effect functions for server-world particle spawning and floating item objects. `VFXCompat.spawnParticles` uses reflection to call the best-matching `ServerWorld.spawnParticles` signature across mappings.
Public API
